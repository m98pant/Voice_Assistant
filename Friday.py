    ...
    def TaskException(self):
        ...
        while True:
            ...
            if 'wikipedia' in self.q:
                ...
                speak("I am Friday the virtual voice assistant")
...
class Main(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon("C:\\Users\\pantm\\Downloads\\Telegram Desktop\\Brian Voice Assistant\\assets\\favicon.ico"))
        self.ui.pushButton.clicked.connect(self.startTask)
        self.ui.pushButton_2.clicked.connect(self.close)
        self.ui.label.setPixmap(QtGui.QPixmap("C:\\Users\\pantm\\Downloads\\Telegram Desktop\\Brian Voice Assistant\\assets\\bg-img.jpg"))
        
    def startTask(self):
        self.ui.movie = QtGui.QMovie("C:\\Users\\pantm\\Downloads\\Telegram Desktop\\Brian Voice Assistant\\assets\\center.gif")
